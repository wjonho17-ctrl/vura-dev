...
const { layoutConfig, isDarkTheme, storeConfig } = useLayout();
...
const primaryColors = ref(COLORS)
...
function applyAppConfig() {
    updateColors('primary', { name: layoutConfig.primary })
    updateColors('surface', { name: layoutConfig.surface })
...
<template>
    <div
        class="config-panel top-13 right-0 w-64 p-4 bg-surface-0 dark:bg-surface-900 origin-top shadow-[0px_3px_5px_rgba(0,0,0,0.02),0px_0px_2px_rgba(0,0,0,0.05),0px_1px_4px_rgba(0,0,0,0.08)]">
